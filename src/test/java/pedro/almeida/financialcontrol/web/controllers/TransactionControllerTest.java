...
public class TransactionControllerTest {
    ...
    void registerWithAValidTransactionShouldReturn201AndTheCreatedTransaction() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders
                ...
                .andExpect(jsonPath("$.time").value(expectedTransaction.getTimestamp().format(ConfigConstants.TRANSACTION_TIME_FORMATTER)));
    }
    ...
    public void findAllWithMonthAndYearShouldReturn200AndAListOfTransactions() throws Exception {
        ...
        for (int i = 0; i < expectedTransactions.size(); i++) {
            ...
            mockMvc.perform(MockMvcRequestBuilders.get(uri)
                    ...
                    .andExpect(jsonPath("$[" + i + "].time").value(transaction.getTimestamp().format(ConfigConstants.TRANSACTION_TIME_FORMATTER)));
        }
    }
